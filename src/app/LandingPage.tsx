        ...
        <div className="mx-auto max-w-6xl px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div className="flex flex-col rounded-md border border-line bg-paper p-6">
              ...
              <p className="mb-5 flex-1 text-sm leading-relaxed text-slate">
                أصدر تفويضًا موثّقًا توقّعه أنت (الموكِّل) بصفتك مُصدِر التفويض، ليحصل بموجبه المفوَّض له على وثيقة
                معتمدة برقم توثيق ورمز QR، مناسبة للوكالات والتفويضات السريعة التي لا تتطلب أطرافًا متعددة.
              </p>
              <button
                type="button"
