...
// "الرئيسية" رابط منفصل يفتح صفحة الموقع العامة (المحتوى التسويقي)، و"عقودي"
// رابط منفصل يفتح لوحة التحكم — كانا مدمجين سابقًا في رابط واحد لتفادي تكرار
// كان قائمًا بين "الصفحة الرئيسية" وأربعة روابط فرعية لحالات العقود، لكن ذلك
