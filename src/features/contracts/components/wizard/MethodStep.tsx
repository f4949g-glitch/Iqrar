...
export function MethodStep({ onSelect, onBack }: MethodStepProps) {
  return (
    <div className="space-y-6">
      <p className="text-sm text-slate">اختر طريقة إنشاء محتوى العقد</p>
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        >
          ...
          <div>
            <h3 className="font-display text-sm font-bold text-ink">كتابة العقد داخل المنصة</h3>
