-- تحقق خادمي إضافي بأن التفويض لا يمكن أن يتضمن أكثر من طرف واحد، إلى جانب
-- التحقق الحالي في واجهة المستخدم (PartiesStep).
...
begin
  ...
  if v_row.document_type = 'power_of_attorney' and v_party_count > 1 then
