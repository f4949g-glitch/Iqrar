-- إعادة التفويض إلى طرف واحد فقط (الموكِّل، صاحب الحساب) بناءً على طلب المالك:
-- كانت 20260720153000 تشترط طرفين بالضبط للتفويض، فتُحدَّث send_contract هنا
-- لتشترط طرفًا واحدًا فقط للتفويض — ويُذكَر اسم الموكَّل له داخل نص الوثيقة لا
-- كطرف مستقل. بقية منطق الدالة (SECURITY DEFINER، فحص الملكية، حساب الفاتورة
-- والخصم) دون تغيير.
